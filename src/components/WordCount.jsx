            ...
            <Row>
                ...
                <Col md={12}>
                    <Row className='text-center'>
                        <Col md={4}>
                            <h4 className='text-primary mb-0 fs-1'>{wordCountTotal}</h4>
                        ...
                        <Col md={4}>
                            <h4 className='text-primary mb-0 fs-1'>{charTotal}</h4>
                        ...
                        <Col md={4}>
                            <h4 className='text-primary mb-0 fs-1'>{charExcludingSpaceTotal}</h4>
